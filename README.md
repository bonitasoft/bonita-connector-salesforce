...
- Run the [Create release](https://github.com/bonitasoft/bonita-connector-salesforce/actions/workflows/release.yml) action, set the version to release as parameter
